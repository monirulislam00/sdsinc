            ...
            <div class="row p-2">
                <div class="card-body col-md-6">
                    ...
                    <div class="form-group-mb-3">
                        ...
                        <img class="d-block" style="max-width: 300px" src="{{ asset($product->image) }}" alt="">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="service" id="" class="form-control">
                            ...
                            @foreach ($services as $service)
                                <option @if ($product->getService->id == $service->id) selected @endif value="{{ $service->id }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="product_type" id="" class="form-control">
                            ...
                            @foreach ($product_types as $type)
                                <option @if ($product->getProductType->id == $type->id) selected @endif value="{{ $type->id }}">
                                    {{ $type->name }}</option>
                            @endforeach
                        </select>
                        <small class="text-danger">
                ...
                <div class="card-body col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <textarea type="text" name="description" class="form-control" rows="8">{{ str_replace('<br>', "\r\n", $product->description) }}</textarea>
                        <small class="text-danger">
                            @error('description')
                                {{ $message }}
                            @enderror
