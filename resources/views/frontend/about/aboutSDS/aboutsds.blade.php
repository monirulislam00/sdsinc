    ...
    <div class="row">
        <div class="com-md-12 col-xs-12">
            <header class="section-header wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <h2 style="text-align: center;">About SDSInc.</h2>
            </header>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="about-content">
                    <h2>Our Mission</h2>
                    <p>To create long-term, sustainable value for customers and shareholders by developing, marketing, and supporting products that deliver rapid return on investment through lower costs and improved customer responsiveness.</p>
                </div>
                <div>
                    <h2>Our Values</h2>
                    <ul>
                        <li>To enable our customers to attain and exceed their business objectives through our partnership.</li>
                        <li>To provide an environment for our employees which fosters personal growth, economic reward and challenging opportunities.</li>
...
<section class="section-bg">
    ...
    <h2 style="text-align: center">Why SDSInc?</h2>
