...
@section('home_content')
            ...
            <div class="row">
                ...
                {{-- <div class="col-md-4 ">
                    <div class="content mt-4 p-3 shadow-md">
                        ...
                        <div class="description">
                            <p>Let us help you maximize the potential of mobile technology on your behalf by developing an
                                advanced app for it. To cater to the specific requirements of your company, we are the name
                                to rely on for developing your custom mobile applications.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ">
                    <div class="content mt-4 p-3 shadow-md">
                        ...
                        <div class="description">
                            <p>Feeling like left out without the right e-commerce solution that can help your products or
                                services reach the maximum customers? Guess what? Our expert team can get you that with a
                                shopping cart, payment gateway, inventory management, or any other feature you’ll ask for.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ">
                    <div class="content mt-4 p-3 shadow-md">
                        ...
                        <div class="description">
                            <p>Unlock the full potential of your software development and IT operations with iBOS's DevOps
                                Services. Our solutions are designed to automate away inefficiencies, improve the quality
                                and reliability of your software, and optimize your IT operations lifecycle and workflows.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ">
                    <div class="content mt-4 p-3 shadow-md">
                        ...
                        <div class="description">
                            <p>Utilize our state-of-the-art Business Intelligence services to bring your company to its
                                maximum potential. We’re offering the know-how and resources to help you make sense of your
                                data using a variety of methods, from visual analysis to predictive modeling.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ">
                    <div class="content mt-4 p-3 shadow-md">
                        ...
                        <div class="description">
                            <p>Experience the future of technology with our innovative Augmented Reality and Virtual Reality
                                solutions. Our team of experts utilizes the latest AR and VR technology to bring your
                                products, services, and ideas to life.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ">
                ...
                <div class="col-md-4 ">
                    <div class="content mt-4 p-3 shadow-md">
                        ...
                        <div class="description">
                            <p>Making the right solutions isn’t the toughest job anymore. It’s finding the right resource to
                                pull that off. We believe we can help you with that with our finest professionals, and our
    ...
    <section class="serve">
        <div class="container">
            <div class="title">
                <h2 class="font-bold"><span>INDUSTRIES WE</span> SERVE</h2>
            </div>
            <div class="row">
                <div class="col-md-3">
    ...
    <section class="blog my-5">
        <div class="container">
            <div class="title flex justify-between">
                <h2 class="font-bold"><span>OUR</span> BLOGS</h2>
                ...
                @foreach ($blogs as $blog)
                    <div class="col-md-4 blog-item p-3">
                        <a href="blog/{{ $blog->title }}" class="m-4">
                            <img style="width:100%" class=" border-0 p-0" src="{{ $blog->image }}" width="100%"
                                alt="tech blog" />
